...
!function(ns){
    ...
    ns.ITranslation.prototype = {
        ...
        setArtsAndCulture:function( ArtsAndCulture ){ },
        setCareerAndBusiness:function( CareerAndBusiness ){ },
        setCarsAndMotorcycles:function( CarsAndMotorcycles ){ },
        setCommunityAndEnvironment:function( CommunityAndEnvironment ){ },
        setDancing:function( Dancing ){ },
        setEducationAndLearning:function( EducationAndLearning ){ },
        setFashionAndBeauty:function( FashionAndBeauty ){ },
        setFitness:function( Fitness ){ },
        setFoodAndDrink:function( FoodAndDrink ){ },
        setGames:function( Games ){ },
        setMovementsAndPolitics:function( MovementsAndPolitics ){ },
        setHealthAndWellbeing:function( HealthAndWellbeing ){ },
        setHobbiesAndCrafts:function( HobbiesAndCrafts ){ },
        setLanguageAndEthnic:function( LanguageAndEthnic ){ },
        setIdentity:function( Identity ){ },
        setLGBTeqAngel:function( LGBTeqAngel ){ },
        setLifestyle:function( Lifestyle ){ },
        setLiteratureAndWriting:function( LiteratureAndWriting ){ },
        setMoviesAndFilm:function( MoviesAndFilm ){ },
        setMusic:function( Music ){ },
        setNewAgeAndSpirituality:function( NewAgeAndSpirituality ){ }
    };
